	...
	<Content app-name="mail">
		...
		<AppContent>
			...
			<div class="wrapper flex_row">
				...
				<div class="flex_column filter-set-head">
					<label for="setAsActive">{{ t('mail', 'Activate Script when saving') }}</label>
					<input id="setAsActive" v-model="isActiveScript" type="checkbox" value="active" />
				</div>
				<div class="flex_column filter-set-head">
					<input
						type="button"
...
export default {
	...
	methods: {
		...
		saveScriptFile() {
			// we keep all parameters when tests or actions are switched
			...
			var filterRules = [
				{
					index: 0,
					type: 'comment',
					value: '## Generated by Nextcloud Mail ##'
				},
				{
					index: 1,
					name: 'new Rule',
